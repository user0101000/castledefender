...
Um jogo de ação em terceira pessoa onde o jogador deve defender o castelo de ondas de monstros.

### Controles
| Ação | Tecla |
| :--- | :--- |
| **Movimento** | `W`, `A`, `S`, `D` |
| **Ataque** | `Mouse 1` (Botão Esquerdo) |
| **Câmera** | `Mouse` |
| **Pular** | `Espaço` |
...
<img width="719" height="388" alt="print1" src="https://github.com/user-attachments/assets/0debbafe-67ab-44f3-9501-a9d27d88655e" />
<img width="560" height="364" alt="print5" src="https://github.com/user-attachments/assets/328c3eed-2b93-4c89-a926-a0ba34f21908" />
...
* Unity Engine (Versão 6000.2.8f1)
* C#
* Assets: RPG Combat System, Hyper casual cartoon castles, Magic Effects FREE, etc.
